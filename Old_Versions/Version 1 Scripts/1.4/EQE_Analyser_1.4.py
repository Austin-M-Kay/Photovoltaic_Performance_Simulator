...
# <br/><br/>
# All these widgets for creating a customised are now compiled into one widget box (alongside a graph), which can be called into the user interface shortly.
# <br/><br/>
